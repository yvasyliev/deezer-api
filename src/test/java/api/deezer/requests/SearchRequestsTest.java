...
class SearchRequestsTest {
    ...
    @Test
    void searchAlbum() {
        SearchRequest<AlbumData> searchRequest = deezerApi.search().searchAlbum("nevermind").strict().order(SearchOrder.ALBUM_ASC).limit(5).offset(1);
        ...
        assertEquals("1", searchRequest.getParams().get("offset"));
    ...
    @Test
    void searchArtist() {
        SearchRequest<ArtistData> searchRequest = deezerApi.search().searchArtist("eminem").strict().order(SearchOrder.ARTIST_DESC).limit(5).offset(1);
    ...
    @Test
    void searchPlaylist() {
        SearchRequest<PlaylistData> searchRequest = deezerApi.search().searchPlaylist("2020").strict().order(SearchOrder.DURATION_ASC).limit(5).offset(1);
    ...
    @Test
    void searchRadio() {
        SearchRequest<RadioData> searchRequest = deezerApi.search().searchRadio("indie").strict().order(SearchOrder.RATING_DESC).limit(5).offset(1);
    ...
    @Test
    void searchTrack() {
        SearchRequest<TrackData> searchRequest = deezerApi.search().searchTrack("star").strict().order(SearchOrder.TRACK_ASC).limit(5).offset(1);
    ...
    @Test
    void searchUser() {
        SearchRequest<UserData> searchRequest = deezerApi.search().searchUser("arthur").strict().order(SearchOrder.RANKING).limit(5).offset(1);
